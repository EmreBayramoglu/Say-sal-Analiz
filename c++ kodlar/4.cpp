...
double na5;
 ...
 na1=sqrt(pow(a11,2)+pow(a21,2)+pow(a31,2)+pow(a41,2)+pow(a51,2));
 na2=sqrt(pow(a12,2)+pow(a22,2)+pow(a32,2)+pow(a42,2)+pow(a52,2));
 na3=sqrt(pow(a13,2)+pow(a23,2)+pow(a33,2)+pow(a43,2)+pow(a53,2));
 na4=sqrt(pow(a14,2)+pow(a24,2)+pow(a34,2)+pow(a44,2)+pow(a54,2));
 na5=sqrt(pow(a15,2)+pow(a25,2)+pow(a35,2)+pow(a45,2)+pow(a55,2));
